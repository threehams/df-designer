module "react-redux" {
  ...
  >(
    ...
    actions: TActions,
  ): [TSelected, ResolveArrayThunks<TActions>];
  export function useRedux<
    TState,
    TSelected,
    TActions extends [
  ...
  export function useRedux<
    TState,
    TSelected,
    TActions extends ReadonlyArray<ActionCreator<any>>
  >(
    selector: (state: TState) => TSelected,
    actions: TActions,
  ): [TSelected, ResolveArrayThunks<TActions>];
  export function useRedux<
    TState,
    TSelected,
    TActions extends { [key: string]: ActionCreator<any> }
  >(
    selector: (state: TState) => TSelected,
    actions: TActions,
  ): [TSelected, ResolveThunks<TActions>];
  export function useRedux<
    TState,
    TSelected,
    TActions extends ActionCreator<any>,
  ...
  >(
    selector: (state: TState) => TSelected,
    actions: TActions,
  ): [TSelected, HandleThunkActionCreator<TActions>];
